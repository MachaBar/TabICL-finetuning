...
class TabICLClassifier(ClassifierMixin, BaseEstimator):
    ...
    def _load_model(self):
        ...
        #     """
        # Get the project root dynamically (two levels up from this file)
        BASE_DIR = Path(__file__).resolve().parent.parent.parent.parent.parent
        print("Load checkpoints custom !")
        if self.checkpoint_version == "original":
            print("Original checkpoint !")
            checkpoint_path = BASE_DIR / "tabicl-classifier-v1.1-0506.ckpt"
        else:
            print("Fine-tuned checkpoint !")
            checkpoint_path = BASE_DIR / "checkpoints" / "model_best.pth"
        ...
        #     print("Fine-tuned checkpoint !")
        #     checkpoint = torch.load(
        #         "/home/D32485/exercice/checkpoints/model_best.pth", map_location="cpu"
        #     )
